...
🇧🇷 ***Leia este README em Português:*** [README_pt-BR](README_pt-BR.md)

# Server Summary

RavoraSMP is a simple lore-driven survival server with custom resources, built on the Java Edition and running on the latest version (1.21.11).  
